...
Проект теперь включает удобный веб-интерфейс для поиска:
...
- ⚡ Показ времени выполнения и метрик производительности
- 📱 Адаптивный дизайн для мобильных устройств
- 🎛️ Настройка лимита результатов и подробного режима
- 📝 Подробные логи в терминале и файлах
...
# Быстрый тест одного запроса (командная строка)
